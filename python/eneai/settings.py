"""
Django settings for eneai project.
...
SECRET_KEY = "django-insecure-*l+rfnont%s6$7zg@_p$fvn+h@brpmzb06@-b$*)6vmu4j7ly$"
...
WSGI_APPLICATION = "eneai.wsgi.application"
